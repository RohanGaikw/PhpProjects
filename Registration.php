           ...
           <form action="Registration.php" method="post">
            <table> 
                <tr>
                    ...
                    <td><input type5="text" name="fname" id="fname" autocomplete="off" required></td>
                </tr>
                <tr>
 ...
 
{
    ...
    $query = "insert into register(fname,lname,mobno,email,pass,cpass) values('$fname','$lname','$email','$mob','$pass','$cpass')";
